...
function(ml_try_compile_with_flags RESULT SOURCE FLAGS)
    set(TEST_FILE_CPP "${CMAKE_BINARY_DIR}/CMakeFiles/ml_try_compile_with_flags.cpp")
    set(TEST_FILE_EXE "${CMAKE_BINARY_DIR}/CMakeFiles/ml_try_compile_with_flags${CMAKE_EXECUTABLE_SUFFIX}")
...
# Returns first flag that is passed that makes SOURCE compilable
function(ml_select_flag RESULT SOURCE OLD_FLAGS)
    ...
    foreach(testflag IN LISTS ARGN)
        ...
        if (NOT FLAG_FOUND)
            ...
            ml_try_compile_with_flags(TRY_COMPILE_FOUND "${SOURCE}" "${OLD_FLAGS} ${testflag}")
