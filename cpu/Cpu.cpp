...
#include <MatrixLibrary/Core/Platform.h>
...
namespace ML
{
  ...
  void CMLCpu::Cpuid(SMLX86Registers* pRegisters)
  {
    if (pRegisters)
    {
#if defined(ML_COMPILER_MSVC)
...
#else
#error Please add compiler support for CMLCpu::Cpuid on your compiler.
#endif
    }
  }
